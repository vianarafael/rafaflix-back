    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!authHeader) {
                    return [2 /*return*/, response.status(401).json({ message: 'Token is required' })];
                }
                _a = authHeader.split(' '), token = _a[1];
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, jwt.verify(token, process.env.APP_SECRET)];
            case 2:
                _b.sent();
                next();
                return [3 /*break*/, 4];
            case 3:
                err_1 = _b.sent();
                // The token is either not correct or expired
