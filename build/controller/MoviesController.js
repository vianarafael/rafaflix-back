    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, typeorm_1.getRepository(Movies_1.Movies)
                        .find({
                        where: {
                            user_id: user_id
                        }
...
exports.addMovie = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, user_id = _a.user_id, movie_id = _a.movie_id;
                return [4 /*yield*/, typeorm_1.getRepository(Movies_1.Movies).save({
                        user_id: user_id,
                        movie_id: movie_id
                    })];
            case 1:
...
exports.deleteMovie = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, user_id = _a.user_id, movie_id = _a.movie_id;
                return [4 /*yield*/, typeorm_1.getRepository(Movies_1.Movies).delete({ user_id: user_id, movie_id: movie_id })];
            case 1:
                movie = _b.sent();
                response.json(movie);
                return [2 /*return*/];
