...
var login = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                if (_b.sent()) {
                    token = jwt.sign({ id: user[0].id }, process.env.APP_SECRET, {
                        expiresIn: '1d'
                    });
                    data = {
                        id: user[0].id,
                ...
                return [3 /*break*/, 4];
            case 3: return [2 /*return*/, response.status(404).json({ message: 'user not found' })];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).save({
                        name: name,
                        email: email,
